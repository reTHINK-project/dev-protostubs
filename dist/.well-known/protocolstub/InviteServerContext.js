...
System.register(["sip.js"], function (_export, _context) {
  ...
  var SIP, Session, C, hasDescription, InviteServerContext;
  return {
    ...
    execute: function () {
      ...
      InviteServerContext.prototype = {
        ...
        progress: function progress(options) {
          ...
          function do100rel() {
            ...
            extraHeaders.push('RSeq: ' + Math.floor(Math.random() * 10000)); // Get the session description to add to preaccept with
      ...
      _export("default", InviteServerContext);
    }
  };
});