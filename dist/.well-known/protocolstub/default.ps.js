...
System.register([], function (_export, _context) {
  ...
  var protostubDescriptor, VertxProtoStub;
  ...
  return {
    ...
    execute: function () {
      ...
      **/
      ...
      function () {
        ...
        */
        ...
        _createClass(VertxProtoStub, [{
            ...
            bus.addListener('*', function (msg) {
              ...
              _this._open(function () {
                if (_this._filter(msg)) {
                  ...
                  msg.body.via = _this2._runtimeSessionURL;
          ...
          key: "_sendData",
          value: function _sendData(callback) {
            var _this = this;
          ...
          value: function _open(callback) {
            ...
            if (!_this._sock) {
              ...
              _this._sock.onclose = function (event) {
                var reason; //See https://tools.ietf.org/html/rfc6455#section-7.4
      ...
      _export("default", VertxProtoStub);
