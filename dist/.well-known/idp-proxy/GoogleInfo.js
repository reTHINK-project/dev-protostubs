...
System.register([], function (_export, _context) {
  ...
  var redirectURI, googleInfo, googleAPIInfo;
  ...
  function accessTokenAuthorisationEndpoint(API) {
    var url = googleAPIInfo.authorisationEndpoint + 'redirect_uri=' + redirectURI + '&response_type=' + googleAPIInfo.type + '&client_id=' + googleAPIInfo.clientID + '&scope=' + 'https://www.googleapis.com/auth/' + API + '&access_type=' + googleAPIInfo.accessType //    + '&include_granted_scopes=true'
    //    + '&prompt=none'
  ...
  return {
    ...
    execute: function () {
      ...
      _export("googleAPIInfo", googleAPIInfo = {
        "clientID": "808329566012-tqr8qoh111942gd2kg007t0s8f277roi.apps.googleusercontent.com",
        "issuer": "https://accounts.google.com",
        "tokenEndpoint": "https://www.googleapis.com/oauth2/v4/token?",
