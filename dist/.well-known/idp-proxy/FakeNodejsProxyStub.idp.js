...
System.register([], function (_export, _context) {
  ...
  var identities, nIdentity, btoa, atob, googleInfo, idp, NodejsProxyStub, generateMessageResponse;
      ...
      idp = {
        ...
        */
        validateAssertion: function validateAssertion(assertion, origin) {
          console.log('validateAssertionProxyNODEJSFAKE:assertion', assertion); //TODO check the values with the hash received
