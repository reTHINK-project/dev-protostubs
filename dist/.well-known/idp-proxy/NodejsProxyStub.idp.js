...
System.register([], function (_export, _context) {
  ...
  var identities, nIdentity, https, btoa, atob, googleInfo, getAuth, exchangeCode, idp, NodejsProxyStub, generateMessageResponse;
  ...
  **/
  ...
  return {
    ...
    execute: function () {
      ...
      getAuth = function getAuth(contents) {
        var i = googleInfo;
        return new Promise(function (resolve, reject) {
      ...
      exchangeCode = function exchangeCode(code) {
        ...
        return new Promise(function (resolve, reject) {
          ...
          sendHTTPRequest('POST', URL).then(function (info) {
            ...
            console.log('[IDPROXY.exchangeCode:err]', error.message); //reject(error);
          });
        });
      };
      /**
      ...
      idp = {
        ...
        */
        validateAssertion: function validateAssertion(assertion, origin) {
          console.log('validateAssertionProxyNODEJS', assertion); //TODO check the values with the hash received
        ...
        generateAssertion: function generateAssertion(contents, origin, hint) {
          ...
          return new Promise(function (resolve, reject) {
            ...
            if (!hint) {
              ...
              return resolve(generateMessageResponse); // the request have already been made, so idpPRoxy will exchange the tokens along to the idp, to obtain the information necessary
              ...
              exchangeCode(code).then(function (value) {
                console.log('TIAGO exchange code'); //obtain information about the user
                ...
                sendHTTPRequest('GET', infoTokenURL).then(function (infoToken) {
                  ...
                  var idTokenURL = i.tokenInfo + value.id_token; //obtain information about the user idToken
                ...
                console.log('[IDPROXY.generateAssertion:exchangeCode]', err); //reject(err);
              });
            }
          });
        }
