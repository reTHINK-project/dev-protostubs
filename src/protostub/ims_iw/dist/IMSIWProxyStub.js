  ...
  _createClass(IMSIWProxyStub, [{
    ...
    value: function generateAssertion(contents, origin, hint) {
      ...
      return new Promise(function (resolve, reject) {
        ...
        if (!hint) {
          var requestUrl = 'https://accounts.google.com/o/oauth2/v2/auth?scope=email%20profile&state=%2Fprofile&redirect_uri=https%3A%2F%2Flocalhost&response_type=token&client_id=808329566012-tqr8qoh111942gd2kg007t0s8f277roi.apps.googleusercontent.com';
          ...
          var infoToken = { picture: '', email: 'email@email.com', family_name: '', given_name: '' };
          var assertion = btoa(JSON.stringify({ tokenID: accessToken, email: 'email@email.com', id: 1 }));
