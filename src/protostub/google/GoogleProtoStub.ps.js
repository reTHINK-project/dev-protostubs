...
class GoogleProtoStub {
  ...
  _setUpReporter(identity, objectDescURL, data, resources, name, reuseURL) {
    ...
    return new Promise(function (resolve, reject) {
      ...
      _this._syncher.create(objectDescURL, [], data, true, false, name, identity, input)
        .then((reporter) => {
  ...
  _eventBusUsage() {
    ...
    return new Promise(function (resolve, reject) {
      ...
      _this._eb.onopen = () => {
        ...
        let done = false;
        while (!done) {
          console.log('[GoogleProtoStub] Waiting for SockJS readyState', _this._eb.sockJSConn.readyState, '(', WebSocket.OPEN, ')');
