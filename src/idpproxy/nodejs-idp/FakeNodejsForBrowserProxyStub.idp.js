...
let idp = {
  ...
  */
  validateAssertion: (assertion, origin) => {
    console.log('validateAssertionProxyNODEJSFAKEBrowser');
    ...
    return new Promise(function(resolve,reject) {
      ...
      console.log('validateAssertionProxyNODEJSFAKEBrowser:beforebtoa');

      let decodedContent = atob(assertion);
      console.log('validateAssertionProxyNODEJSFAKEBrowser:btoa', decodedContent);

      let content = JSON.parse(decodedContent);
      console.log('validateAssertionProxyNODEJSFAKEBrowser:parse', content);


      let idTokenSplited = content.tokenID.split('.');
      console.log('validateAssertionProxyNODEJSFAKEBrowser:split', idTokenSplited);


      let idToken = JSON.parse(atob(idTokenSplited[1]));
      console.log('validateAssertionProxyNODEJSFAKEBrowser:idToken', idToken);


      console.log('validateAssertionProxyNODEJSFAKEBrowser:idToken.email', idToken.email);
      console.log('validateAssertionProxyNODEJSFAKEBrowser:idToken.nonce', idToken.nonce);
