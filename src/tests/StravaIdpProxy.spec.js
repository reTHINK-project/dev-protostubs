...
import StravaIdpProxyProtoStub from '../idpproxy/strava/StravaIdpProxyStub.idp';
...
let assertion;
let idpProxyUrl = 'domain-idp://strava.com';
...
let idpProxy = new StravaIdpProxyProtoStub(idpProxyUrl, bus, {});
